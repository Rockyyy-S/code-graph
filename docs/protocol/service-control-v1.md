...
`supportedSchemaVersions`、`workspaceKey`、`sessionToken`。服务依次校验请求形状、token、
workspace-key 与协议主版本。成功的 `InitializeResult` 返回四套独立版本、服务版本、
capabilities 与权威 `ServiceStatusV1`。
